// src/icons/LongDistance/LongDistance.tsx
import { SVGProps } from "react";

export default function LongDistance(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox='0 0 24 24'
      width='1em'
    ...
    >
      <path
        ...
        strokeLinecap='round'
      />
      <path d='M20.5 18.5L16.5 3.5' strokeLinecap='round' />
      <path d='M3.5 18.5L7.5 3.5' strokeLinecap='round' />
      <path d='M12 10.5V8.5' strokeLinecap='round' />
      <path d='M12 5.5V3.5' strokeLinecap='round' />
    </svg>
  );
}
